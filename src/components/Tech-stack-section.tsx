    ...
    <div className='mb-[30px] pt-[30px] border-t-[1px] border-[#e1e3e6]'>
      <div className='pb-5 flex flex-wrap gap-[15px] text-sm'>
        ...
        <span className='flex items-center gap-1'>
          ...
          <a href='https://x.com/Kaialogen' target='_blank' rel='noopener noreferrer' className='hover:underline'>
            @Kaialogen
          </a>
        </span>
        <span className='flex items-center gap-1'>
        ...
        <span className='flex items-center gap-1'>
          ...
          <a href='https://github.com/Kaialogen' target='_blank' rel='noopener noreferrer' className='hover:underline'>
            Kaialogen
          </a>
        </span>
      </div>
