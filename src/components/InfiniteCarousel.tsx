import { FaReact, FaJsSquare, FaGitAlt, FaHtml5, FaCss3Alt, FaNodeJs, FaNpm, FaPython, FaDocker } from 'react-icons/fa';
import { SiTypescript, SiTailwindcss, SiRedux, SiJest, SiMongodb, SiGraphql, SiNetlify, SiGo } from 'react-icons/si';
