  ...
  return (
    <section className='p-6 rounded-2xl bg-Cosmic-Black shadow-md h-full'>
      ...
      <div className='w-full grid grid-cols-2 gap-8 max-md:grid-cols-1'>
        ...
        <div className='rounded-lg w-full border p-5 flex flex-col gap-5 border-WhiteChalk/40'>
          <div className='w-full h-40 mb-4 rounded-lg overflow-hidden'>
            <img src='/' alt='Project Thumbnail' className='w-full h-full object-cover' width={600} height={380} />
          </div>
          <div className='flex flex-col'>
            <h2 className='text-2xl font-semibold text-WhiteChalk'>Hurst Chat</h2>
            <p className='text-WhiteChalk opacity-50'>
              A full-stack Social Media app with a React frontend and Express backend, featuring user authentication and
